...
/******/ 	var hotCurrentHash = "18c30a9fc67bcd3edef7"; // eslint-disable-line no-unused-vars
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__sass_app_scss__ = __webpack_require__("./src/sass/app.scss");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_home_js__ = __webpack_require__("./src/components/home.js");
//sass
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_barba_js__ = __webpack_require__("./node_modules/barba.js/dist/barba.js");
...
const quotes = ['"When something is important enough, you do it even if the odds are not in your favor"', '"SpaceX designs, manufactures and launches advanced rockets and spacecraft"', '"I\'m not trying to be anyone\'s savior. I\'m just trying to think about the future and not be sad"'];
...
const cursorCheckBoundaries = elements => {
    for (const element of elements) {
        if (coords.x > element.getBoundingClientRect().left && coords.x < element.getBoundingClientRect().left + element.clientWidth && coords.y > element.getBoundingClientRect().top && coords.y < element.getBoundingClientRect().top + element.clientHeight) {
...
const animate = () => {
    ...
    if (stars.length < 100 && frameCount % 30 == 0) {
        let random = {
